...
resource "azurerm_network_interface" "vm-nic" {
    name                 = "nic-vm${var.vm_type}-${var.subscription_type}-${var.vm_type}-${var.location}" #-${var.instance_number}"
    location             = var.location
    resource_group_name  = var.resource_group_name
    enable_ip_forwarding = var.enable_ip_forwarding

    ip_configuration {
      name                          = "ip-vm${var.vm_type}-${var.subscription_type}-${var.vm_type}-${var.location}" #-${var.instance_number}"
